...
import com.khm1102.mediprice.global.filter.CacheControlInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    /**
     * {@code /api/**}에 URI 패턴별 Cache-Control을 붙인다.
     * ETag 자체는 {@link WebAppInitializer}가 등록한 {@code ShallowEtagHeaderFilter}가 담당.
     */
    @Override
