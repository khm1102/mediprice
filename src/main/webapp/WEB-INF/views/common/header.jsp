...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/spoqa/spoqa-han-sans@latest/css/SpoqaHanSansNeo.css">
    ...
    <script defer src="<c:url value='/static/js/api.js'/>?v=20260607-ux3"></script>
    <script defer src="<c:url value='/static/js/auth.js'/>?v=20260607-ux3"></script>
    <script defer src="<c:url value='/static/js/common.js'/>?v=20260607-ux3"></script>
</head>
